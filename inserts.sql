...
(3, 'Goku Son', '789 Kame House, Ilha de Kame', 'goku@natheus.com', 999999997),
(4, 'Vegeta Prince', '1 Royal Street, Planeta Vegeta', 'vegeta@natheus.com', 999999996),
(5, 'Natsu Dragneel', 'Fire Dragon Guild, Magnolia Town', 'natsu@natheus.com', 999999995),
(6, 'Erza Scarlet', 'Fairy Tail Guild, Magnolia Town', 'erza@natheus', 999999994),
(7, 'Monkey D. Luffy', 'Thousand Sunny, Grand Line', 'luffy@natheus.com', 999999993),
(8, 'Saitama', 'Apt. 303, Z-City', 'saitama@natheus.com', 999999992),
(9, 'Narancia Ghirga', 'Gang Passione Headquarters, Napoli', 'narancia@natheus.com', 999999991),
